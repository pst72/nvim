...
function M.get_winbar()
  ...
  if navic.is_available() then
    return '%#WinBarSeparator#' .. '%=' .. icons.arrows.ArrowLeft .. '%*' .. get_location() .. '%#WinBarSeparator# ' .. icons.arrows.ArrowRight .. '%*'
  else
    return '%#WinBarSeparator#' .. '%=' .. icons.arrows.ArrowLeft .. '%*' .. get_modified() .. '%#WinBarSeparator# ' .. icons.arrows.ArrowRight .. '%*'
  end
end
