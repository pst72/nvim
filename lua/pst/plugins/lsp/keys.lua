...
M._keys = {
  ...
  { 'leaderlh', '<cmd>print(vim.inspect(vim.tbl_keys(vim.lsp.handlers)))<cr>', desc = 'Lsp Handlers Capabilities' },
  ...
  { '<leader>lwd', '<cmd>Telescope diagnostics<cr>', desc = 'Workspace Diagnostic Symbols' },
